...
namespace AmeliorateAegis.Data.Migrations
{
    ...
    [Migration("20211023161152_Added Other Sub Systems")]
    partial class AddedOtherSubSystems
    {
            ...
            modelBuilder.Entity("AmeliorateAegis.Models.Centre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationTime = new DateTime(2021, 10, 23, 18, 11, 50, 864, DateTimeKind.Local).AddTicks(8468),
                            Name = "Kabega"
                        },
                        new
                        {
                            ...
                            CreationTime = new DateTime(2021, 10, 23, 18, 11, 50, 867, DateTimeKind.Local).AddTicks(7423),
                            Name = "Sol Futi"
                        },
                        new
                        {
                            ...
                            AddressLine1 = "123 John Newton SW",
                            AddressLine2 = "Newton Park",
                            CreationTime = new DateTime(2021, 10, 23, 18, 11, 50, 867, DateTimeKind.Local).AddTicks(7505),
                            Name = "Daku"
                        });
                });
            ...
            modelBuilder.Entity("AmeliorateAegis.Models.Period", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationTime = new DateTime(2021, 10, 23, 18, 11, 50, 869, DateTimeKind.Local).AddTicks(1700),
                            Name = "Term 1"
                        },
                        new
                        {
                            Id = 2L,
                            CreationTime = new DateTime(2021, 10, 23, 18, 11, 50, 869, DateTimeKind.Local).AddTicks(3079),
                            Name = "Term 2"
                        },
                        new
                        {
                            Id = 3L,
                            CreationTime = new DateTime(2021, 10, 23, 18, 11, 50, 869, DateTimeKind.Local).AddTicks(3134),
                            Name = "Term 3"
                        },
                        new
                        {
                            Id = 4L,
                            CreationTime = new DateTime(2021, 10, 23, 18, 11, 50, 869, DateTimeKind.Local).AddTicks(3136),
                            Name = "Term 4"
                        });
                });
            ...
            modelBuilder.Entity("AmeliorateAegis.Models.Programme", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CentreId = 1L,
                            CreationTime = new DateTime(2021, 10, 23, 18, 11, 50, 869, DateTimeKind.Local).AddTicks(4179),
                        ...
                        new
                        {
                            Id = 2L,
                            CentreId = 2L,
                            CreationTime = new DateTime(2021, 10, 23, 18, 11, 50, 869, DateTimeKind.Local).AddTicks(6052),
                        ...
                        new
                        {
                            Id = 3L,
                            CentreId = 1L,
                            CreationTime = new DateTime(2021, 10, 23, 18, 11, 50, 869, DateTimeKind.Local).AddTicks(6107),
                            Name = "Song And Music"
                        },
                        new
                        {
                            Id = 4L,
                            CentreId = 1L,
                            CreationTime = new DateTime(2021, 10, 23, 18, 11, 50, 869, DateTimeKind.Local).AddTicks(6265),
                            Name = "Art And Music"
                        },
                        new
                        {
                            Id = 5L,
                            CentreId = 3L,
                            CreationTime = new DateTime(2021, 10, 23, 18, 11, 50, 869, DateTimeKind.Local).AddTicks(6276),
            ...
            modelBuilder.Entity("AmeliorateAegis.Models.ProgressReport", b =>
                {
                    ...
                    b.HasOne("AmeliorateAegis.Models.ApplicationUser", "Teacher")
                        .WithMany()
                        .HasForeignKey("TeacherId");
                });
